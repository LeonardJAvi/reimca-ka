...
ActiveRecord::Schema.define(version: 20171221154134) do
  ...
  create_table "stack_cities", force: :cascade do |t|
    t.string   "name",           limit: 255
  ...
  create_table "works", force: :cascade do |t|
    ...
    t.text     "description",     limit: 65535
    t.string   "stack_state_id",  limit: 255
    t.string   "stack_city_id",   limit: 255
    t.string   "type_project_id", limit: 255
